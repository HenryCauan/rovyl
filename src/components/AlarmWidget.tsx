...
export const AlarmWidget: React.FC<AlarmWidgetProps> = ({ isOpen, onClose, alarms, setAlarms }) => {
      ...
      >
        ...
        <div className="p-6 border-b border-white/10 flex justify-between items-center bg-[#141414]">
            <div className="flex items-center gap-3">
                ...
                <h2 className="text-white font-medium text-lg">Alarms</h2>
            </div>
            ...
            <AnimatePresence mode="wait">
                {isAdding ? (
                    ...
                    >
                        ...
                        <span className="font-medium">Add New Alarm</span>
                    </button>
                )}
            </AnimatePresence>
        </div>
